REM @ SCRIPT FOR DELETING TEMPORARY FILES
REM @ RETR0
...
REM Deletes all user temporary folders and temporary files
...
REM defines the user's Profile folder and deletes the temporary files there
